...
webpackConfig.entry = {
    app: __DEV__ ? [APP_ENTRY_PATH, `webpack-hot-middleware/client?path=${config.compiler_public_path}__webpack_hmr`] : [APP_ENTRY_PATH],
...
webpackConfig.module.loaders.push(
    ...
    { test: /\.svg(\?.*)?$/, loader: 'url?prefix=fonts/&name=[path][name].[ext]&limit=10000&mimetype=images/svg+xml' },
    { test: /\.(ico|gif|png|jpg|jpeg|webp)$/, loader: 'url?limit=8192' }
)
    /* eslint-enable */
